...
public class GenerarInformacionEmpleados {
	...
	public static List<Empleado> generarEmpleados() {
		...
		empleados.add(new Empleado("Pablo", "Calle", LocalDate.of(2021, 04, 12), LocalDate.of(2045, 04, 12),
				Sexo.MASCULINO, "Sevilla", Puesto.INGENIERO, 1500.0));
		empleados.add(new Empleado("Marco", "Fernández", LocalDate.of(2022, 04, 06), LocalDate.of(2023, 04, 06),
				Sexo.MASCULINO, "Sevilla", Puesto.INGENIERO, 1700.0));
		empleados.add(new Empleado("Miguel", "Reyes", LocalDate.of(2021, 04, 11), LocalDate.of(2023, 04, 11),
				Sexo.MASCULINO, "Sevilla", Puesto.INGENIERO, 1500.0));
		return empleados;
	...
	public static void imprimirInformacionEmpleados(List<Empleado> empleados) {
		try {
			String ruta = "C:\\Users\\pcallep\\Documents\\"; // Establezca su ruta del directorio de salida del fichero
																// aquí
			...
			for (Empleado empleado : empleados) {
				...
				System.out.println("Antigüedad laboral del empleado (en años): " + empleado.antiguedadLaboral());
				...
				if (empleados.lastIndexOf(empleado) == empleados.size() - 1)
					bufferedWriter.write("}" + "\n");
				else
					bufferedWriter.write("}," + "\n");
				i++;
